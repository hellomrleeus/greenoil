...
export const TRANSLATIONS = {
  zh: {
    ...
    fs_competitor_quote_placeholder: "例如 $0.25/L 或 toast_export_csv: "已导出 CSV"5/桶 或 赠送隔油池清洗",
  ...
  en: {
    ...
    fs_competitor_quote_placeholder: "e.g. $0.25/L or toast_export_csv: "CSV Exported"5/drum or free grease trap cleaning",
  ...
  ko: {
    ...
    fs_competitor_quote_placeholder: "예: $0.25/L 또는 통당 toast_export_csv: "CSV 내보내기 완료"5 또는 그리스 트랩 세척 무료 지원",
