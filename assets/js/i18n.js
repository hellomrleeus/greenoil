...
export const TRANSLATIONS = {
  zh: {
    ...
    nav_hint_title: "导航提示",
    fs_route_nav_segments_title: "分段路线列表 (每段最多 9 家餐馆，无缝衔接)",
  ...
  en: {
    ...
    fs_route_nav_segments_title: "Segmented Routes (Up to 9 stops each, seamless)",
  ...
  ko: {
    ...
    fs_route_nav_segments_title: "구간별 경로 목록 (구간당 최대 9개 식당, 연속 주행)",
