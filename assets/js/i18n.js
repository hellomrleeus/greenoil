...
export const TRANSLATIONS = {
  zh: {
    ...
    fs_record_route_prompt: "优先推荐当前路线规划中的途经站点",
  ...
  en: {
    ...
    fs_record_route_prompt: "Prioritizing stops from current route planning list",
    ...
    legend_new_place: "Not in KV Database",
  ...
  ko: {
    ...
    fs_record_route_prompt: "현재 경로 계획의 정류장을 우선 추천합니다",
