...
export const TRANSLATIONS = {
  zh: {
    ...
    fs_route_nav_modal_title: "智能路线导航方案",
    fs_route_nav_modal_tip: "当前共有 {count} 个地点。由于手机端 Google Maps App 外部调用限制为最多 10 个地点，建议手机跑店使用分段导航；网页端或车机大屏可直接打开全量拼接路线。",
    fs_route_nav_btn_full: "打开全量完整路线 (网页版/车机推荐)",
    ...
    fs_msg_optimized: "已按经纬度几何最短拓扑排序调整拜访顺序",
  ...
  en: {
    ...
    fs_route_nav_modal_title: "Route Navigation Options",
    fs_route_nav_modal_tip: "There are {count} stops in total. Mobile Google Maps limits external routes to 10 stops. Segmented navigation is recommended for mobile driving, while desktop or in-car browsers can open the full stitched route.",
    ...
    fs_msg_optimized: "Visit order optimized based on shortest topological distance",
  ...
  ko: {
    ...
    fs_route_nav_modal_title: "스마트 경로 내비게이션 옵션",
    fs_route_nav_modal_tip: "현재 총 {count}개 경유지가 있습니다. 모바일 Google 지도는 단일 외부 경로당 최대 10개 지점으로 제한됩니다. 모바일 앱 주행 시 구간별 분할 내비게이션을 권장하며, 웹이나 차량 화면에서는 전체 연결 경로를 열 수 있습니다.",
    fs_route_nav_btn_full: "전체 경로 열기 (웹 / 차량용 추천)",
    ...
    fs_msg_optimized: "최단 이동 거리 순으로 방문 순서가 재정렬되었습니다",
