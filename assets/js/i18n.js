...
export const TRANSLATIONS = {
  zh: {
    ...
    btn_search_this_area_loading: "正在搜索当前视野...",
    map_viewport_title: "当前地图视野",
    map_viewport_summary: "当前地图视野内检索到 {count} 家商户",
    map_viewport_toast: "已刷新当前视野商户：共 {count} 家",
    map_load_more_batch: "加载更多商家 (+20)",
    map_all_loaded: "已加载全部 {count} 家商户",
    btn_deep_search: "深度探测 (100+)",
    deep_searching: "正在深度探测周边商家...",
    deep_search_toast: "深度探测完成：共聚合 {count} 家商户",
    map_legend_hq: "起点",
    ...
    btn_import_waypoints: "导入站点",
    btn_export_waypoints: "导出清单",
    btn_expand_waypoints: "展开站点列表",
    btn_collapse_waypoints: "收起站点列表",
    btn_lock_stops: "锁定组合",
    btn_unlock_stops: "解锁组合",
    badge_locked_group: "组{groupNum}",
    badge_locked_group_tip: "已锁定为不可分割整体",
    batch_select_all: "全选",
    batch_selected_count: "已选 {count} 项",
    waypoints_search_placeholder: "搜索途经站点（店名/地址）...",
    alert_lock_min_two: "至少需要选择 2 个站点才能锁定为组合。",
    alert_locked_delete_forbidden: "所选站点包含已被锁定的站点，必须先解锁后再删除！",
    alert_single_locked_delete: "该站点处于锁定组合中，请先解锁后再删除。",
    toast_locked_group_success: "已成功将 {count} 个站点锁定为组合",
    toast_unlocked_group_success: "已解除站点的锁定组合",
    import_modal_title: "导入途经站点",
    import_tab_text: "粘贴多行地址",
    import_tab_file: "上传 Excel/CSV",
    import_text_placeholder: "支持每行粘贴一个地址或餐馆名称，例如：\n915 Danforth Ave, Toronto, ON\n3235 Hwy 7 Unit 17, Markham, ON\nBurger King Markham",
    import_btn_submit: "识别并导入",
    import_success_toast: "成功导入 {count} 个途经站点",
    import_file_drop_hint: "点击选择或将 .xlsx / .csv 文件拖拽至此处",
    waypoints_drag_tip: "拖拽调整途经点顺序，路线实时更新",
    waypoints_drag_handle_tip: "拖拽排序",
    ...
    map_origin_hq_title: "Green Oil HQ (起点)",
    map_origin_hq_popup: "起点：Green Oil HQ",
    excel_col_index: "序号",
    excel_col_name: "餐厅名称",
    excel_col_address: "地址",
    excel_col_phone: "电话",
    excel_col_hours: "营业时间",
    excel_col_eta: "预计抵达",
    map_loading_place_details: "正在获取地点详情...",
    map_place_details_failed: "地点详情加载失败，请重试",
    map_context_coords: "坐标: {coords}",
    map_context_set_origin: "设为路线起点",
    map_coord_prefix: "坐标: ",
    ...
    toast_renamed_tab: "已重命名路线标签为「{name}」",
    calc_quote_title: "【Green Oil 餐厅用油与废油测算单】",
    calc_quote_rest: "餐馆名称：",
    calc_quote_default_rest: "普通餐馆",
    calc_quote_summary_header: "[用油与废油预估]",
    trap_quote_title: "【Green Oil 隔油池维护报价单】",
    trap_quote_client: "客户/餐馆：",
    trap_quote_default_rest: "普通餐馆"
  },
  ...
  en: {
    ...
    fs_route_tab_new_tip: "Create new route tab",
    ...
    btn_search_this_area_loading: "Searching this area...",
    map_viewport_title: "Current Viewport",
    map_viewport_summary: "Found {count} places in current viewport",
    map_viewport_toast: "Updated current viewport: {count} places",
    map_load_more_batch: "Load More Places (+20)",
    map_all_loaded: "All {count} places loaded",
    btn_deep_search: "Deep Search (100+)",
    deep_searching: "Performing deep multi-category discovery...",
    deep_search_toast: "Deep discovery completed: {count} unique places",
    map_legend_hq: "Start",
    ...
    btn_import_waypoints: "Import Stops",
    btn_export_waypoints: "Export List",
    btn_expand_waypoints: "Expand Waypoints",
    btn_collapse_waypoints: "Collapse Waypoints",
    btn_lock_stops: "Lock Group",
    btn_unlock_stops: "Unlock Group",
    badge_locked_group: "Group {groupNum}",
    badge_locked_group_tip: "Locked as an indivisible group",
    batch_select_all: "Select All",
    batch_selected_count: "{count} selected",
    waypoints_search_placeholder: "Search stops (name/address)...",
    alert_lock_min_two: "Select at least 2 stops to lock as a group.",
    alert_locked_delete_forbidden: "Selected stops contain locked stops. Please unlock them before deleting!",
    alert_single_locked_delete: "This stop is part of a locked group. Please unlock it before deleting.",
    toast_locked_group_success: "Locked {count} stops into a group",
    toast_unlocked_group_success: "Unlocked stop group",
    import_modal_title: "Import Route Stops",
    import_tab_text: "Paste Addresses",
    import_tab_file: "Upload Excel/CSV",
    import_text_placeholder: "Paste one address or restaurant name per line, e.g.:\n915 Danforth Ave, Toronto, ON\n3235 Hwy 7 Unit 17, Markham, ON\nBurger King Markham",
    import_btn_submit: "Parse & Import",
    import_success_toast: "Successfully imported {count} stops",
    import_file_drop_hint: "Click to select or drag .xlsx / .csv file here",
    waypoints_drag_tip: "Drag to reorder stops; route updates in real time",
    waypoints_drag_handle_tip: "Drag to reorder",
    ...
    map_origin_hq_title: "Green Oil HQ (Origin)",
    map_origin_hq_popup: "Origin: Green Oil HQ",
    excel_col_index: "No.",
    excel_col_name: "Restaurant Name",
    excel_col_address: "Address",
    excel_col_phone: "Phone",
    excel_col_hours: "Business Hours",
    excel_col_eta: "Est. Arrival",
    map_loading_place_details: "Loading place details...",
    map_place_details_failed: "Failed to load place details. Please try again.",
    map_context_coords: "Coordinates: {coords}",
    map_context_set_origin: "Set as Route Origin",
    map_coord_prefix: "Coordinates: ",
    ...
    toast_renamed_tab: "Renamed route tab to \"{name}\"",
    calc_quote_title: "【Green Oil Cooking Oil & UCO Estimate】",
    calc_quote_rest: "Restaurant: ",
    calc_quote_default_rest: "Standard Restaurant",
    calc_quote_summary_header: "[Oil & UCO Volume Estimate]",
    trap_quote_title: "【Green Oil Grease Trap Maintenance Quote】",
    trap_quote_client: "Client/Restaurant: ",
    trap_quote_default_rest: "Standard Restaurant"
  },
  ...
  ko: {
    ...
    fs_route_tab_new_tip: "새 경로 탭 생성",
    ...
    btn_search_this_area_loading: "현재 시야 매장 검색 중...",
    map_viewport_title: "현재 지도 시야",
    map_viewport_summary: "현재 지도 시야 내 {count}개 매장 검색됨",
    map_viewport_toast: "현재 시야 매장 갱신: 총 {count}개",
    map_load_more_batch: "매장 더 불러오기 (+20)",
    map_all_loaded: "전체 {count}개 매장 로드됨",
    btn_deep_search: "심층 검색 (100+)",
    deep_searching: "주변 매장 심층 검색 중...",
    deep_search_toast: "심층 검색 완료: 총 {count}개 매장",
    map_legend_hq: "출발점",
    ...
    btn_import_waypoints: "경유지 가져오기",
    btn_export_waypoints: "목록 내보내기",
    btn_expand_waypoints: "경유지 목록 펼치기",
    btn_collapse_waypoints: "경유지 목록 접기",
    btn_lock_stops: "그룹 잠금",
    btn_unlock_stops: "잠금 해제",
    badge_locked_group: "그룹 {groupNum}",
    badge_locked_group_tip: "분할할 수 없는 그룹으로 잠김",
    batch_select_all: "전체 선택",
    batch_selected_count: "{count}개 선택됨",
    waypoints_search_placeholder: "경유지 검색 (매장명/주소)...",
    alert_lock_min_two: "그룹으로 잠그려면 최소 2개 이상의 경유지를 선택해야 합니다.",
    alert_locked_delete_forbidden: "선택된 경유지에 잠긴 항목이 포함되어 있습니다. 먼저 잠금을 해제한 후 삭제해주세요!",
    alert_single_locked_delete: "이 경유지는 잠금 그룹에 속해 있습니다. 삭제하려면 먼저 잠금을 해제해주세요.",
    toast_locked_group_success: "{count}개 경유지를 그룹으로 잠갔습니다",
    toast_unlocked_group_success: "경유지 그룹 잠금을 해제했습니다",
    import_modal_title: "경유지 일정 가져오기",
    import_tab_text: "주소 붙여넣기",
    import_tab_file: "엑셀/CSV 업로드",
    import_text_placeholder: "한 줄에 하나의 주소 또는 식당명을 입력하세요. 예:\n915 Danforth Ave, Toronto, ON\n3235 Hwy 7 Unit 17, Markham, ON\nBurger King Markham",
    import_btn_submit: "분석 및 가져오기",
    import_success_toast: "{count}개의 경유지를 성공적으로 가져왔습니다",
    import_file_drop_hint: ".xlsx / .csv 파일을 클릭하거나 여기에 드래그하세요",
    waypoints_drag_tip: "경유지를 드래그하여 순서를 변경하면 경로가 실시간 갱신됩니다",
    waypoints_drag_handle_tip: "드래그하여 순서 변경",
    ...
    map_origin_hq_title: "Green Oil HQ (출발지)",
    map_origin_hq_popup: "출발지: Green Oil HQ",
    excel_col_index: "번호",
    excel_col_name: "식당명",
    excel_col_address: "주소",
    excel_col_phone: "전화번호",
    excel_col_hours: "영업시간",
    excel_col_eta: "예상 도착",
    map_loading_place_details: "장소 상세 정보를 불러오는 중...",
    map_place_details_failed: "장소 정보를 불러오지 못했습니다. 다시 시도해 주세요.",
    map_context_coords: "좌표: {coords}",
    map_context_set_origin: "경로 출발지로 설정",
    map_coord_prefix: "좌표: ",
    ...
    toast_renamed_tab: "경로 탭 이름이 \"{name}\"으로 변경됨",
    calc_quote_title: "【Green Oil 식당 식용유 및 폐유 견적서】",
    calc_quote_rest: "식당명: ",
    calc_quote_default_rest: "일반 식당",
    calc_quote_summary_header: "[식용유 및 폐유 추정치]",
    trap_quote_title: "【Green Oil 그리스트랩 유지보수 견적서】",
    trap_quote_client: "고객/식당: ",
    trap_quote_default_rest: "일반 식당"
  }
};
